...
def test_prompts_are_single_source():
    """SEARCHER_PROMPT (lean_searcher's) and THINKING_INSTRUCTION (shared)
    are imported once and not duplicated."""
...
def test_anthropic_tools_are_single_source():
    """lean_searcher's harness and agent class both reach the same
    ANTHROPIC_TOOLS object — no fork."""
